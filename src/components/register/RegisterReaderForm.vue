  ...
  >
    ...
    >
      <form
        ...
        "
      >
        <div class="flex w-full flex-start gap-2 my-12">
          <StepperItem
            v-for="step in steps"
            :key="step.step"
            v-slot="{ state }"
                      ...
                      <Popover>
                        <PopoverTrigger asChild>
                          ...
                          >
                            ...
                            {{
                              componentField.modelValue ? componentField.modelValue : 'Chọn ngày'
                            }}
                          </Button>
                        </PopoverTrigger>
        ...
        <div class="flex items-center justify-between mt-4 space-x-2">
          <Button :disabled="isPrevDisabled" variant="outline" @click="prevStep()" class="w-full">
            Quay lại
          </Button>
